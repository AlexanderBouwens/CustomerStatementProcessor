 ...
 *
 *	The XMLTransactionItemProcessor verifies whether the transactions read from a flat file abide the business rules.
 ...
 *
 */
public class XMLTransactionItemProcessor implements ItemProcessor<Transaction, Transaction> {
    ...
    public Transaction process(final Transaction transaction) throws Exception {
    	...
    	ids.add(transaction.getReference());
